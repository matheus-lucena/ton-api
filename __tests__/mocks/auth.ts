import { AdminCreateUserRequest, AdminCreateUserResponse, AdminGetUserResponse, AdminSetUserPasswordRequest, AdminSetUserPasswordResponse, AuthenticationResultType } from "@aws-sdk/client-cognito-identity-provider";
